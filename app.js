...
function onStartGame() {
	...
	for(var i = 0; i < IDs.length; i++) {
		...
		var newPlayer = new Player(spawnPoint.x * TILE_SIZE, spawnPoint.y * TILE_SIZE, "down", playerId, pendingGame.players[playerId].color,pendingGame.players[playerId].name);
